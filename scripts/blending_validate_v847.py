...
def main() -> None:
    ...
    artifact_checks = module.run_artifact_checks(args.output_root)
    print(f"core_tests: PASS (20 checks); artifact_checks: {artifact_checks}")
