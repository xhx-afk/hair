"""Highlight hue drift is invalid when the highlight support is too small."""
...
def main() -> None:
    ...
    assert float(metrics["highlight_hue_metric_valid"].mean()) == 0.0
    assert float(metrics["highlight_hue_drift_valid"].mean()) == 0.0
    print("V2.41.2 highlight validity tests: PASS")
