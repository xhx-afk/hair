...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=Path, default=Path("input/pp_dataset_v1"))
    parser.add_argument("--fid_dataset", type=str, default="input")
    parser.add_argument("--batch_size", type=int, default=16)
    parser.add_argument("--epochs", type=int, default=200)
    parser.add_argument("--iter_before", type=int, default=10000)
    parser.add_argument("--d_reg_every", type=int, default=16)
    parser.add_argument("--inpaint", type=float, default=0.0)
