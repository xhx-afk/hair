...
USER_INIT_CKPT = ""
USER_RESUME_CHECKPOINT = "output/shape_train_v12_small/checkpoints/last.pth"
...
USER_SHAPE_PRIOR_STRENGTH_V12 = 0.15

USER_SAVE_CHECKPOINT_EVERY = 1
USER_SAVE_PREVIEW_EVERY = 1
USER_PREVIEW_COUNT = 24

USER_LAMBDA_LATENT_SHAPE = 0.70
USER_LAMBDA_LATENT_PRESERVE = 1.60
USER_LAMBDA_LATENT_REMOVE_PRESERVE = 1.20
USER_LAMBDA_IMAGE_SHAPE = 0.35
USER_LAMBDA_IMAGE_EDGE = 0.25
USER_LAMBDA_IMAGE_PRESERVE = 1.25
USER_LAMBDA_IMAGE_REMOVE_PRESERVE = 0.80
