...
from models.hair_local_recomposition_v838 import HairLocalRecompositionV838
...
USER_V236_DIAGNOSTIC_ONLY = os.environ.get("BLENDING_V236_DIAGNOSTIC_ONLY", "0") == "1"
USER_V236_CHROMA_RADIUS = int(os.environ.get("BLENDING_V236_CHROMA_RADIUS", "9"))
USER_V236_CHROMA_RESIDUAL_RADIUS = int(os.environ.get("BLENDING_V236_CHROMA_RESIDUAL_RADIUS", "3"))
USER_V236_ILLUMINATION_RADIUS = int(os.environ.get("BLENDING_V236_ILLUMINATION_RADIUS", "11"))
USER_V236_CHROMA_SCALE = float(os.environ.get("BLENDING_V236_CHROMA_SCALE", "18.0"))
USER_V236_CHROMA_GAIN = float(os.environ.get("BLENDING_V236_CHROMA_GAIN", "1.0"))
...
USER_V238_DIAGNOSTIC_ONLY = os.environ.get("BLENDING_V238_DIAGNOSTIC_ONLY", "0") == "1"
USER_V238_PALETTE_MAD_SCALE = float(os.environ.get("BLENDING_V238_PALETTE_MAD_SCALE", "3.5"))
USER_V238_PALETTE_MIN_SUPPORT = int(os.environ.get("BLENDING_V238_PALETTE_MIN_SUPPORT", "16"))
USER_V238_ILLUMINATION_RADIUS = int(os.environ.get("BLENDING_V238_ILLUMINATION_RADIUS", "11"))
USER_V238_ANCHOR_HF_GAIN = float(os.environ.get("BLENDING_V238_ANCHOR_HF_GAIN", "0.9"))
USER_V238_CONTACT_RADIUS = int(os.environ.get("BLENDING_V238_CONTACT_RADIUS", "5"))
USER_V238_RISK_STRENGTH = float(os.environ.get("BLENDING_V238_RISK_STRENGTH", "0.65"))
USER_V238_MATTE_RING_RADIUS = int(os.environ.get("BLENDING_V238_MATTE_RING_RADIUS", "5"))
USER_V238_FACE_GUARD = float(os.environ.get("BLENDING_V238_FACE_GUARD", "0.35"))
USER_V238_VISUAL_COUNT = int(os.environ.get("BLENDING_V238_VISUAL_COUNT", "20"))
USER_V239_DIAGNOSTIC_ONLY = os.environ.get("BLENDING_V239_DIAGNOSTIC_ONLY", "0") == "1"
USER_V239_PALETTE_MAD_SCALE = float(os.environ.get("BLENDING_V239_PALETTE_MAD_SCALE", "3.5"))
USER_V239_PALETTE_MIN_SUPPORT = int(os.environ.get("BLENDING_V239_PALETTE_MIN_SUPPORT", "16"))
USER_V239_ILLUMINATION_RADIUS = int(os.environ.get("BLENDING_V239_ILLUMINATION_RADIUS", "11"))
USER_V239_ILLUMINATION_SCALE = float(os.environ.get("BLENDING_V239_ILLUMINATION_SCALE", "0.9"))
USER_V239_ANCHOR_HF_GAIN = float(os.environ.get("BLENDING_V239_ANCHOR_HF_GAIN", "0.9"))
USER_V239_CONTACT_RADIUS = int(os.environ.get("BLENDING_V239_CONTACT_RADIUS", "5"))
USER_V239_RISK_STRENGTH = float(os.environ.get("BLENDING_V239_RISK_STRENGTH", "0.65"))
...
USER_V241_CARRIER_MID_RADIUS = int(os.environ.get("BLENDING_V241_CARRIER_MID_RADIUS", "3"))
USER_V241_MID_GAIN = float(os.environ.get("BLENDING_V241_MID_GAIN", "1.0"))
USER_V241_HIGH_GAIN = float(os.environ.get("BLENDING_V241_HIGH_GAIN", "0.95"))
USER_V241_CHROMA_MID_GAIN = float(os.environ.get("BLENDING_V241_CHROMA_MID_GAIN", "0.35"))
USER_V241_CHROMA_HIGH_GAIN = float(os.environ.get("BLENDING_V241_CHROMA_HIGH_GAIN", "0.20"))
USER_V241_CONTACT_RADIUS = int(os.environ.get("BLENDING_V241_CONTACT_RADIUS", "5"))
USER_V241_MATTE_RING_RADIUS = int(os.environ.get("BLENDING_V241_MATTE_RING_RADIUS", "5"))
USER_V241_VISUAL_COUNT = int(os.environ.get("BLENDING_V241_VISUAL_COUNT", "20"))
...
V241_COLOR_CACHE_SUFFIX = "_v241_stable_hue_gamut_face_guard"
V2411_COLOR_CACHE_SUFFIX = "_v2411_correctness_fix"
...
def fs_cache_name(role: str, stem: str) -> str:
    ...
    if role == "color":
        ...
        elif USER_V2412_DIAGNOSTIC_ONLY:
            suffix = V2412_COLOR_CACHE_SUFFIX
        elif USER_V2411_DIAGNOSTIC_ONLY:
            suffix = V2411_COLOR_CACHE_SUFFIX
        elif USER_V241_DIAGNOSTIC_ONLY:
            suffix = V241_COLOR_CACHE_SUFFIX
        elif USER_V240_DIAGNOSTIC_ONLY:
        ...
        elif USER_V237_DIAGNOSTIC_ONLY:
    ...
    if not USER_BUILD_CACHE_WITH_CURRENT_SATD:
        ...
        if missing:
            ...
            raise RuntimeError(
                ...
                "For V2.35/V2.36, color FS files also require their versioned hair-only namespace. "
...
class BlendingTrainerV8:
    def __init__(
        ...
        self.v236_transfer = HairAppearanceDecompositionTransferV836(
            chroma_radius=USER_V236_CHROMA_RADIUS,
            chroma_residual_radius=USER_V236_CHROMA_RESIDUAL_RADIUS,
            illumination_radius=USER_V236_ILLUMINATION_RADIUS,
            chroma_scale=USER_V236_CHROMA_SCALE,
            chroma_gain=USER_V236_CHROMA_GAIN,
        ...
        self.v238_transfer = HairLocalRecompositionV838(
            palette_mad_scale=USER_V238_PALETTE_MAD_SCALE,
            palette_min_support=USER_V238_PALETTE_MIN_SUPPORT,
            illumination_radius=USER_V238_ILLUMINATION_RADIUS,
            anchor_hf_gain=USER_V238_ANCHOR_HF_GAIN,
            contact_radius=USER_V238_CONTACT_RADIUS,
            risk_strength=USER_V238_RISK_STRENGTH,
            matte_ring_radius=USER_V238_MATTE_RING_RADIUS,
            face_guard=USER_V238_FACE_GUARD,
        )
        self.v239_transfer = HairLocalRecompositionV839(
            palette_mad_scale=USER_V239_PALETTE_MAD_SCALE,
            palette_min_support=USER_V239_PALETTE_MIN_SUPPORT,
            illumination_radius=USER_V239_ILLUMINATION_RADIUS,
            illumination_scale=USER_V239_ILLUMINATION_SCALE,
            anchor_hf_gain=USER_V239_ANCHOR_HF_GAIN,
            contact_radius=USER_V239_CONTACT_RADIUS,
        ...
        self.v241_transfer = transfer_cls(
            ...
            illumination_radius=USER_V241_ILLUMINATION_RADIUS,
            carrier_mid_radius=USER_V241_CARRIER_MID_RADIUS,
            mid_gain=USER_V241_MID_GAIN,
            high_gain=USER_V241_HIGH_GAIN,
            chroma_mid_gain=USER_V241_CHROMA_MID_GAIN,
            chroma_high_gain=USER_V241_CHROMA_HIGH_GAIN,
            contact_radius=USER_V241_CONTACT_RADIUS,
            matte_ring_radius=USER_V241_MATTE_RING_RADIUS,
        )
    ...
    def prepare_batch(self, batch):
        ...
        with torch.no_grad():
            ...
            if USER_V236_DIAGNOSTIC_ONLY or USER_V235_DIAGNOSTIC_ONLY:
        ...
        return {
            ...
            "v230_source_hair_mask": parsing_label_mask(v228_face_parsing, (13,))[valid],
...
"""
    ...
    def run_v238_diagnostic(self):
        ...
        for batch in tqdm(self.val_loader, desc=f"{diagnostic_label} texture-preserving recolor diagnostic", leave=False):
            ...
            runtime_builder = build_v841_runtime_inputs if is_v241 else build_v840_runtime_inputs if is_v240 else build_v839_runtime_inputs if is_v239 else build_v838_runtime_inputs
            runtime = runtime_builder(
                ...
                coarse_target_hair_mask=target_mask,
                source_face_mask=face_mask, source_skin_mask=skin_mask,
                source_hair_mask=prepared.get("v230_source_hair_mask", torch.zeros_like(face_mask)),
                reference_hair_mask=prepared["reference_hair_mask"],
            )
            transfer = self.v241_transfer if is_v241 else self.v240_transfer if is_v240 else self.v239_transfer if is_v239 else self.v238_transfer
            final, aux = transfer(return_aux=True, **runtime)
            metrics_fn = v241_metric_tensors if is_v241 else v240_metric_tensors if is_v240 else v239_metric_tensors if is_v239 else v238_metric_tensors
            metrics = metrics_fn(
                ...
                **({"reference_hair_mask": runtime["reference_hair_mask"]} if (is_v239 or is_v240 or is_v241) else {}),
                **({"strong_anchor_rgb": runtime["strong_anchor_rgb"], "face_contact_ring": aux["face_contact_ring"], "face_intrusion_risk": aux["face_intrusion_risk"]} if (is_v240 or is_v241) else {}),
                **({"source_skin_mask": runtime["source_skin_mask"], "anchor_hair_evidence": aux.get("anchor_hair_evidence"), "gamut_aux": aux} if is_v241 else {}),
                **({"stable_hue_unit_ab": aux.get("stable_hue_unit_ab"), "hue_metric_valid": aux.get("hue_metric_valid")} if is_v241 else {}),
            )
            if is_v242:
                metrics.update(v242_metric_tensors(
                    target_hair_mask=runtime["coarse_target_hair_mask"],
                    source_hair_mask=runtime["source_hair_mask"],
                    source_face_mask=runtime["source_face_mask"],
                    hair_alpha_final=aux["target_hair_alpha_final"],
                    target_hair_core=aux.get("target_hair_core"),
                    target_hair_transition=aux.get("target_hair_transition"),
                    face_boundary_alpha_jump_map=aux.get("face_boundary_alpha_jump_map"),
                ))
            if is_v243:
                metrics.update(v243_metric_tensors(
                    ...
                    coarse_target_hair_mask=runtime["coarse_target_hair_mask"],
                    hair_alpha_final=aux["target_hair_alpha_final"],
                    safe_dense_core=aux["safe_dense_core"],
                    uncertain_core=aux["uncertain_core"],
                    source_skin_mask=runtime["source_skin_mask"],
                    anchor_hair_evidence=aux["anchor_hair_evidence"],
                    strand_structure_confidence=aux["strand_structure_confidence"],
                    hair_support=aux.get("hair_support"),
                    flyaway_candidate=aux.get("flyaway_candidate"),
            ...
            for index, sample_id in enumerate(prepared["sample_id"]):
                ...
                row.update({
                    ...
                    "illumination_effective_gain": float(aux.get("illumination_effective_gain", torch.ones_like(aux["target_hair_alpha_final"]))[index].mean().item()),
                })
                records.append(row)
                if visual_index < (USER_V241_VISUAL_COUNT if is_v241 else USER_V240_VISUAL_COUNT if is_v240 else USER_V239_VISUAL_COUNT if is_v239 else USER_V238_VISUAL_COUNT):
                    visual_ids.append(sample_id)
                    save_preview(root / "comparisons" / "visual" / f"sample_{visual_index:03d}.png", [
                        prepared["face_i"][index:index + 1], prepared["shape_i"][index:index + 1],
                        prepared["color_i"][index:index + 1], base[index:index + 1] * 2 - 1,
                        anchor[index:index + 1] * 2 - 1, aux["new_hair_rgb"][index:index + 1] * 2 - 1,
                        mask_to_preview(aux["target_hair_alpha_final"][index:index + 1]),
                        final[index:index + 1] * 2 - 1,
                    ])
                    if is_v241:
                        save_preview(root / "comparisons" / "diagnostic" / f"sample_{visual_index:03d}.png", [
                            prepared["color_i"][index:index + 1],
                            aux["stable_hue_preview_rgb"][index:index + 1].expand(-1, -1, base.shape[-2], base.shape[-1]) * 2 - 1,
                            runtime["target_illumination_rgb"][index:index + 1] * 2 - 1,
                            aux["new_hair_rgb"][index:index + 1] * 2 - 1,
                            mask_to_preview(aux["anchor_hair_evidence"][index:index + 1]),
                            mask_to_preview(aux["occlusion_allowed_hair"][index:index + 1]),
                            mask_to_preview(aux["combined_contamination_risk"][index:index + 1]),
                            final[index:index + 1] * 2 - 1,
                        ])
                        save_preview(root / "comparisons" / "hue" / f"sample_{visual_index:03d}.png", [
                            prepared["color_i"][index:index + 1],
                            aux["stable_hue_preview_rgb"][index:index + 1].expand(-1, -1, base.shape[-2], base.shape[-1]) * 2 - 1,
                            aux["new_hair_rgb"][index:index + 1] * 2 - 1,
                            final[index:index + 1] * 2 - 1,
                            mask_to_preview((aux["face_overlap_contamination_risk"][index:index + 1] > 0.65).float()),
                            mask_to_preview(aux["gamut_scale_map"][index:index + 1]),
                        ])
                        if is_v243:
                            save_preview(root / "comparisons" / "matte" / f"sample_{visual_index:03d}.png", [
                                prepared["face_i"][index:index + 1],
                                mask_to_preview(runtime["coarse_target_hair_mask"][index:index + 1]),
                                mask_to_preview(aux["dense_core_confidence"][index:index + 1]),
                                mask_to_preview(aux["strand_structure_confidence"][index:index + 1]),
                                mask_to_preview(aux["flyaway_candidate"][index:index + 1]),
                                mask_to_preview(aux["target_hair_alpha_final"][index:index + 1]),
                                final[index:index + 1] * 2 - 1,
                            ])
                            save_preview(root / "comparisons" / "photometric" / f"sample_{visual_index:03d}.png", [
                                prepared["color_i"][index:index + 1],
                                anchor[index:index + 1] * 2 - 1,
                                aux["new_hair_rgb"][index:index + 1] * 2 - 1,
                                mask_to_preview(aux["shadow_chroma_scale"][index:index + 1]),
                                mask_to_preview(aux["highlight_chroma_scale"][index:index + 1]),
                                final[index:index + 1] * 2 - 1,
                            ])
                            save_preview(root / "comparisons" / "ownership" / f"sample_{visual_index:03d}.png", [
                                mask_to_preview(aux["safe_dense_core"][index:index + 1]),
                        ...
                        save_preview(root / "comparisons" / "tone" / f"sample_{visual_index:03d}.png", [
                            ...
                            aux["intrinsic_tone_preview_rgb"][index:index + 1].expand(-1, -1, base.shape[-2], base.shape[-1]) * 2 - 1,
                            mask_to_preview(aux["target_l_raw"][index:index + 1] / 100.0),
                            mask_to_preview(aux["target_illumination_residual"][index:index + 1] / 25.0),
                            mask_to_preview(aux["final_l"][index:index + 1] / 100.0),
                            aux["new_hair_rgb"][index:index + 1] * 2 - 1,
                            final[index:index + 1] * 2 - 1,
                        ])
                    ...
                    debug_values = (
                        ...
                        ("coarse_target_hair_mask.png", mask_to_preview(runtime["coarse_target_hair_mask"][index:index + 1])),
                        ("source_face_mask.png", mask_to_preview(runtime["source_face_mask"][index:index + 1])),
                        ("source_skin_mask.png", mask_to_preview(runtime["source_skin_mask"][index:index + 1])),
                        ("overlap_face_hair.png", mask_to_preview(aux["overlap_face_hair"][index:index + 1])),
                        ("allowed_hair_mask.png", mask_to_preview(aux["occlusion_allowed_hair"][index:index + 1])),
                        ("face_contact_ring.png", mask_to_preview(aux["face_contact_ring"][index:index + 1])),
                        ("face_intrusion_risk.png", mask_to_preview(aux["face_intrusion_risk"][index:index + 1])),
                        ("hair_alpha_final.png", mask_to_preview(aux["target_hair_alpha_final"][index:index + 1])),
                        ("hair_core.png", mask_to_preview(aux["target_hair_core"][index:index + 1])),
                        ("hair_transition.png", mask_to_preview(aux["target_hair_transition"][index:index + 1])),
                        ("hair_background.png", mask_to_preview(aux["target_hair_background"][index:index + 1])),
                    ...
                    if is_v241:
                        debug_values = debug_values + (
                            ("reference_stable_hue.png", aux["stable_hue_preview_rgb"][index:index + 1].expand(-1, -1, base.shape[-2], base.shape[-1]) * 2 - 1),
                            ("reference_global_chroma.png", mask_to_preview(aux["global_chroma"][index:index + 1] / 55.0)),
                            ("reference_valid_hue_fraction.png", mask_to_preview(aux["valid_hue_fraction"][index:index + 1])),
                            ("reference_hue_dispersion.png", mask_to_preview(aux["hue_dispersion_deg"][index:index + 1] / 45.0)),
                            ("target_chroma_field.png", mask_to_preview(aux["target_chroma_field"][index:index + 1] / 55.0)),
                            ("new_chroma_map.png", mask_to_preview(aux["new_chroma"][index:index + 1] / 55.0)),
                            ("gamut_unsafe_map.png", mask_to_preview(aux["gamut_unsafe_map"][index:index + 1])),
                            ("gamut_scale_map.png", mask_to_preview(aux["gamut_scale_map"][index:index + 1])),
                            ("gamut_heavy_compression_map.png", mask_to_preview(aux["gamut_heavy_compression_map"][index:index + 1])),
                            ("anchor_hair_evidence.png", mask_to_preview(aux["anchor_hair_evidence"][index:index + 1])),
                            ("source_hair_mask.png", mask_to_preview(runtime["source_hair_mask"][index:index + 1])),
                            ("target_hair_mask.png", mask_to_preview(aux.get("target_hair_mask", runtime["coarse_target_hair_mask"])[index:index + 1])),
                            ("target_hair_core.png", mask_to_preview(aux["target_hair_core"][index:index + 1])),
                            ("target_hair_transition.png", mask_to_preview(aux["target_hair_transition"][index:index + 1])),
                            ("new_hair_region.png", mask_to_preview(aux.get("new_hair_region", runtime["coarse_target_hair_mask"])[index:index + 1])),
                            ("new_hair_core.png", mask_to_preview(aux.get("new_hair_core", aux["target_hair_core"])[index:index + 1])),
                            ("new_hair_transition.png", mask_to_preview(aux.get("new_hair_transition", aux["target_hair_transition"])[index:index + 1])),
                            ("target_core_ownership.png", mask_to_preview(aux.get("target_core_ownership", aux["occlusion_allowed_hair"])[index:index + 1])),
                            ("target_transition_ownership.png", mask_to_preview(aux.get("target_transition_ownership", aux["occlusion_allowed_hair"])[index:index + 1])),
                            ("target_hair_ownership.png", mask_to_preview(aux["occlusion_allowed_hair"][index:index + 1])),
                            ("resolver_allowed_hair.png", mask_to_preview(aux["occlusion_allowed_hair"][index:index + 1])),
                            ("target_illumination_l_low.png", mask_to_preview(aux["target_l_low"][index:index + 1] / 100.0)),
                            ("target_l_residual.png", mask_to_preview((aux["target_l_residual"][index:index + 1] / 25.0).clamp(-1, 1))),
                            ("mapped_l_low.png", mask_to_preview(aux["mapped_l_low"][index:index + 1] / 100.0)),
                            ("illumination_effective_gain.png", mask_to_preview(aux["illumination_effective_gain"][index:index + 1] / 2.0)),
                            ...
                            ("recolor_delta.png", mask_to_preview(aux["recolor_delta"][index:index + 1])),
                            ("face_overlap.png", mask_to_preview(aux["face_overlap"][index:index + 1])),
                            ("skin_overlap.png", mask_to_preview(aux["skin_contact"][index:index + 1])),
                            ("deep_skin_overlap.png", mask_to_preview(aux["deep_overlap"][index:index + 1])),
                            ("deep_uncertain_skin_overlap.png", mask_to_preview(aux["deep_uncertain_skin_overlap"][index:index + 1])),
                            ("uncertain_skin_overlap.png", mask_to_preview(aux["uncertain_skin_overlap"][index:index + 1])),
                            ("alpha_guarded.png", mask_to_preview(aux["target_hair_alpha_guarded"][index:index + 1])),
                            ("alpha_before_guard.png", mask_to_preview(aux["hair_alpha_raw"][index:index + 1])),
                            ("guard_zone.png", mask_to_preview(aux.get("guard_zone", aux["deep_overlap"])[index:index + 1])),
                            ("alpha_after_guard.png", mask_to_preview(aux["target_hair_alpha_guarded"][index:index + 1])),
                            ("alpha_raw.png", mask_to_preview(aux["hair_alpha_raw"][index:index + 1])),
                            ("alpha_final.png", mask_to_preview(aux["target_hair_alpha_final"][index:index + 1])),
                            ("contact_risk.png", mask_to_preview(aux["face_contact_contamination_risk"][index:index + 1])),
                            ("contamination_risk.png", mask_to_preview(aux["face_overlap_contamination_risk"][index:index + 1])),
                            ("combined_contamination_risk.png", mask_to_preview(aux["combined_contamination_risk"][index:index + 1])),
                            ("final_face_overlap_reject.png", mask_to_preview(aux["final_face_overlap_reject"][index:index + 1])),
                            ("visible_face_mask.png", mask_to_preview(aux["visible_face_mask"][index:index + 1])),
                            ("visible_skin_mask.png", mask_to_preview(aux["visible_skin_mask"][index:index + 1])),
                            ("face_boundary_alpha_jump.png", mask_to_preview(aux["face_boundary_alpha_jump_map"][index:index + 1])),
                        )
                    elif is_v240:
                        debug_values = debug_values + (
                            ("carrier_l_mid.png", mask_to_preview(aux["carrier_l_mid"][index:index + 1] / 30.0)),
                        ...
                        debug_values = debug_values + (
                            ...
                            ("target_l_low.png", mask_to_preview(aux["target_l_low"][index:index + 1] / 100.0)),
                            ("target_illumination_residual.png", mask_to_preview((aux["target_illumination_residual"][index:index + 1] / 25.0).clamp(-1, 1))),
                            ("final_l_low.png", mask_to_preview(aux["final_l_low"][index:index + 1] / 100.0)),
                            ("final_l.png", mask_to_preview(aux["final_l"][index:index + 1] / 100.0)),
                            ("gamut_chroma_scale.png", mask_to_preview(aux["gamut_chroma_scale"][index:index + 1].expand(-1, -1, base.shape[-2], base.shape[-1]))),
                        )
                    if is_v243:
                        debug_values = debug_values + (
                            ("distance_prior.png", mask_to_preview(aux["distance_prior"][index:index + 1])),
                            ("strand_structure_confidence.png", mask_to_preview(aux["strand_structure_confidence"][index:index + 1])),
                            ("skin_conflict.png", mask_to_preview(aux["skin_conflict"][index:index + 1])),
                            ("dense_core_confidence.png", mask_to_preview(aux["dense_core_confidence"][index:index + 1])),
                            ("safe_dense_core.png", mask_to_preview(aux["safe_dense_core"][index:index + 1])),
                            ("uncertain_core.png", mask_to_preview(aux["uncertain_core"][index:index + 1])),
                            ("hair_support.png", mask_to_preview(aux["hair_support"][index:index + 1])),
                            ("outside_band.png", mask_to_preview(aux["outside_band"][index:index + 1])),
                            ("flyaway_candidate.png", mask_to_preview(aux["flyaway_candidate"][index:index + 1])),
                            ("transition_alpha.png", mask_to_preview(aux["transition_alpha"][index:index + 1])),
                            ("flyaway_alpha.png", mask_to_preview(aux["flyaway_alpha"][index:index + 1])),
                            ("alpha_after_guard.png", mask_to_preview(aux["alpha_after_guard"][index:index + 1])),
                            ("scene_illumination_ab.png", mask_to_preview(aux["scene_illumination_ab"][index:index + 1].norm(dim=1, keepdim=True) / 50.0)),
                            ("scene_illumination_reliability.png", mask_to_preview(aux["scene_illumination_reliability"][index:index + 1])),
                            ...
                            ("gamut_precondition_scale.png", mask_to_preview(aux["gamut_precondition_scale"][index:index + 1])),
        ...
        if not records:
            ...
            if is_v242:
                ...
                summary["p90_gamut_heavy_compression_fraction"] = float(np.quantile([row.get("gamut_heavy_compression_fraction", 0.0) for row in records], 0.90))
            elif is_v241:
                summary["median_mid_energy_ratio_upper"] = summary.get("median_mid_energy_ratio", 0.0)
                summary["median_hf_energy_ratio_upper"] = summary.get("median_hf_energy_ratio", 0.0)
                summary.update({
                    "p90_gamut_heavy_compression_fraction": float(np.quantile([row.get("gamut_heavy_compression_fraction", 0.0) for row in records], 0.90)),
                })
            ...
            gates = () if (is_v2412 or is_v242 or is_v243) else (
                ...
                ("median_base_leakage_fraction", 0.45, "V238_BASE_LEAKAGE_FAIL", lambda x, t: x > t),
            ...
            if is_v243:
                gates = gates + (
                    ...
                    ("median_shadow_chroma_ratio", 0.90, "V243_SHADOW_CHROMA_FAIL", lambda x, t: x > t),
                    ("median_highlight_chroma_ratio", 0.95, "V243_HIGHLIGHT_CHROMA_FAIL", lambda x, t: x > t),
                )
            elif is_v2412:
                gates = gates + (
                    ("median_visible_face_rgb_change_from_base", 0.010, "V2412_VISIBLE_FACE_PRESERVATION_FAIL", lambda x, t: x > t),
                    ("median_visible_skin_rgb_change_from_base", 0.010, "V2412_VISIBLE_SKIN_PRESERVATION_FAIL", lambda x, t: x > t),
                    ("median_visible_background_rgb_change_from_base", 0.010, "V2412_VISIBLE_BACKGROUND_PRESERVATION_FAIL", lambda x, t: x > t),
                    ("median_hair_median_l_error", 8.0, "V2412_MEDIAN_L_FAIL", lambda x, t: x > t),
                    ("median_hair_l_q50_error", 8.0, "V2412_L_Q50_FAIL", lambda x, t: x > t),
                    ("median_hair_chroma_magnitude_error", 8.0, "V2412_CHROMA_FAIL", lambda x, t: x > t),
                    ("median_low_chroma_hair_l_error", 7.0, "V2412_LOW_CHROMA_L_FAIL", lambda x, t: x > t),
                    ("median_low_chroma_tone_fidelity", 0.45, "V2412_LOW_CHROMA_TONE_FAIL", lambda x, t: x < t),
                    ("median_mid_energy_ratio", 0.80, "V2412_MID_TEXTURE_LOW", lambda x, t: x < t),
                    ("median_mid_energy_ratio", 1.25, "V2412_MID_TEXTURE_HIGH", lambda x, t: x > t),
                    ("median_hf_energy_ratio", 0.75, "V2412_HF_TEXTURE_LOW", lambda x, t: x < t),
                    ("median_hf_energy_ratio", 1.35, "V2412_HF_TEXTURE_HIGH", lambda x, t: x > t),
                    ("median_mid_structure_corr", 0.75, "V2412_MID_STRUCTURE_FAIL", lambda x, t: x < t),
                    ("median_gradient_structure_corr", 0.75, "V2412_GRADIENT_STRUCTURE_FAIL", lambda x, t: x < t),
                    ("median_stable_hue_error_deg", 12.0, "V2412_STABLE_HUE_FAIL", lambda x, t: x > t),
                    ("median_hair_hue_outlier_fraction", 0.08, "V2412_HUE_OUTLIER_FAIL", lambda x, t: x > t),
                    ("median_high_chroma_hue_outlier_fraction", 0.05, "V2412_HIGH_CHROMA_HUE_OUTLIER_FAIL", lambda x, t: x > t),
                    ("median_highlight_hue_drift", 8.0, "V2412_HIGHLIGHT_HUE_DRIFT_FAIL", lambda x, t: x > t),
                    ("median_p10_gamut_scale", 0.55, "V2412_GAMUT_SCALE_FAIL", lambda x, t: x < t),
                    ("median_gamut_heavy_compression_fraction", 0.03, "V2412_GAMUT_HEAVY_COMPRESSION_FAIL", lambda x, t: x > t),
                    ("p90_gamut_heavy_compression_fraction", 0.08, "V2412_GAMUT_HEAVY_COMPRESSION_P90_FAIL", lambda x, t: x > t),
                    ("median_uncertain_skin_overlap_bleed", 0.010, "V2412_SKIN_OVERLAP_BLEED_FAIL", lambda x, t: x > t),
                    ("median_deep_uncertain_skin_overlap_bleed", 0.010, "V2412_DEEP_UNCERTAIN_SKIN_BLEED_FAIL", lambda x, t: x > t),
                )
                low_required = max(5, int(np.ceil(0.05 * len(records))))
                if summary.get("low_chroma_valid_sample_count", 0) < low_required:
                    gates = tuple(gate for gate in gates if gate[0] not in ("median_low_chroma_hair_l_error", "median_low_chroma_tone_fidelity"))
            elif is_v241:
                gates = gates + (
                    ("median_mid_energy_ratio", 0.80, "V241_MID_TEXTURE_LOW", lambda x, t: x < t),
                    ("median_mid_energy_ratio_upper", 1.25, "V241_MID_TEXTURE_HIGH", lambda x, t: x > t),
                    ("median_hf_energy_ratio", 0.75, "V241_HF_TEXTURE_LOW", lambda x, t: x < t),
                    ("median_hf_energy_ratio_upper", 1.35, "V241_HF_TEXTURE_HIGH", lambda x, t: x > t),
                    ("median_mid_structure_corr", 0.75, "V241_MID_STRUCTURE_FAIL", lambda x, t: x < t),
                    ("median_gradient_structure_corr", 0.75, "V241_GRADIENT_STRUCTURE_FAIL", lambda x, t: x < t),
                    ("median_hair_hue_outlier_fraction", 0.08, "V241_HUE_OUTLIER_FAIL", lambda x, t: x > t),
                    ("median_high_chroma_hue_outlier_fraction", 0.05, "V241_HIGH_CHROMA_HUE_OUTLIER_FAIL", lambda x, t: x > t),
                    ("median_highlight_hue_drift", 8.0, "V241_HIGHLIGHT_HUE_DRIFT_FAIL", lambda x, t: x > t),
                    ("median_p10_gamut_scale", 0.55, "V241_GAMUT_SCALE_FAIL", lambda x, t: x < t),
                    ("median_gamut_heavy_compression_fraction", 0.03, "V241_GAMUT_HEAVY_COMPRESSION_FAIL", lambda x, t: x > t),
                    ("p90_gamut_heavy_compression_fraction", 0.08, "V241_GAMUT_HEAVY_COMPRESSION_P90_FAIL", lambda x, t: x > t),
                    ("median_uncertain_skin_overlap_bleed", 0.010, "V241_SKIN_OVERLAP_BLEED_FAIL", lambda x, t: x > t),
                    ("median_deep_skin_overlap_bleed", 0.010, "V241_DEEP_SKIN_OVERLAP_BLEED_FAIL", lambda x, t: x > t),
                )
            elif is_v240:
                gates = gates + (
                ...
                gates = gates + (
                    ...
                    ("median_hair_hue_error_deg", 12.0, "V239_HUE_FAIL", lambda x, t: x > t),
                    ("median_hair_chroma_magnitude_error", 8.0, "V239_CHROMA_FAIL", lambda x, t: x > t),
                    ("median_low_chroma_hair_l_error", 7.0, "V239_LOW_CHROMA_TONE_FAIL", lambda x, t: x > t),
                )
        ...
        shutil.copytree(root, active_root, dirs_exist_ok=True)
        print(f"[{diagnostic_label}] failed_gates={payload.get('failed_gates', [])}")
        print(f"[{diagnostic_label}] Decision={payload['automatic_decision']}")
        return payload
    ...
    @torch.inference_mode()
    def run_v241_diagnostic(self):
        return self.run_v238_diagnostic()

    @torch.inference_mode()
    def run_v2411_diagnostic(self):
        return self.run_v238_diagnostic()

    @torch.inference_mode()
    def run_v2412_diagnostic(self):
        return self.run_v238_diagnostic()
    ...
    def run_v236_diagnostic(self):
        ...
        root = Path("res") / "v236"
        active_root = ACTIVE_OUTPUT_DIR / "v236"
        for path in (
            root, root / "debug", root / "comparisons" / "visual",
            root / "comparisons" / "hair_mask", root / "comparisons" / "appearance",
        ...
        pp_state = torch.load(USER_V227_PP_CHECKPOINT, map_location=self.device)
        post_process.load_state_dict(pp_state["model_state_dict"])
        for batch in tqdm(self.val_loader, desc="V2.36 hair appearance diagnostic", leave=False):
            prepared = self.prepare_batch(batch)
            if prepared is None:
                continue
            base, anchor, _, _, v233_baseline = self._render_v231_baselines(prepared, post_process)
            ...
            runtime = build_v836_runtime_inputs(
                ...
                illumination_rgb=base,
                target_hair_mask=prepared["v224_target_hair_mask"],
                anchor_hair_mask=prepared["v224_target_hair_mask"],
                face_mask=prepared["v230_source_face_mask"],
                reference_hair_mask=prepared["reference_hair_mask"],
                illumination_hair_mask=prepared["v224_target_hair_mask"],
            )
            final, aux = self.v236_transfer(return_aux=True, **runtime)
            ...
            ownership_den = aux["hair_ownership"].flatten(1).sum(1).clamp_min(1e-6)
            illumination_change = (
                aux["gated_illumination_residual"].abs() * aux["hair_ownership"]
            ).flatten(1).sum(1) / ownership_den
            for index, sample_id in enumerate(prepared["sample_id"]):
                row = {"sample_id": sample_id}
                row.update({key: float(value[index].item()) for key, value in metrics.items()})
                row.update({
                    ...
                    "chroma_confidence_mean": float(aux["chroma_confidence"][index].mean().item()),
                    "illumination_l_change_mean": float(illumination_change[index].item()),
                })
                records.append(row)
                if visual_index < USER_V236_VISUAL_COUNT:
                    visual_ids.append(sample_id)
                    illumination_preview = mask_to_preview(
                        aux["hair_illumination_map"][index:index + 1]
                    )
                    save_preview(root / "comparisons" / "visual" / f"sample_{visual_index:03d}.png", [
                        prepared["face_i"][index:index + 1], prepared["shape_i"][index:index + 1],
                        prepared["color_i"][index:index + 1], base[index:index + 1] * 2 - 1,
                        anchor[index:index + 1] * 2 - 1, v233_baseline[index:index + 1] * 2 - 1,
                        aux["hair_chroma_map"][index:index + 1] * 2 - 1,
                        illumination_preview, final[index:index + 1] * 2 - 1,
                    ])
                    save_preview(root / "comparisons" / "hair_mask" / f"sample_{visual_index:03d}.png", [
                        ...
                        mask_to_preview(aux["chroma_confidence"][index:index + 1]),
                    ])
                    residual_preview = aux["illumination_residual"][index:index + 1].repeat(1, 3, 1, 1) / USER_V236_MAX_ILLUMINATION_SHIFT
                    save_preview(root / "comparisons" / "appearance" / f"sample_{visual_index:03d}.png", [
                        aux["hair_chroma_map"][index:index + 1] * 2 - 1,
                        illumination_preview, residual_preview,
                        final[index:index + 1] * 2 - 1,
                    ])
                    save_preview(root / "comparisons" / "confidence" / f"sample_{visual_index:03d}.png", [
                        mask_to_preview(aux["support_confidence"][index:index + 1]),
                        mask_to_preview(aux["chroma_similarity"][index:index + 1]),
                        mask_to_preview(aux["chroma_confidence"][index:index + 1]),
                    ])
                    debug_root = root / "debug" / f"sample_{visual_index:03d}"
                    save_preview(debug_root / "hair_chroma_map.png", aux["hair_chroma_map"][index:index + 1] * 2 - 1)
                    save_preview(debug_root / "hair_illumination_map.png", illumination_preview)
                    save_preview(debug_root / "illumination_residual.png", residual_preview)
                    save_preview(debug_root / "chroma_confidence.png", mask_to_preview(aux["chroma_confidence"][index:index + 1]))
                    save_preview(debug_root / "final_leakage_map.png", mask_to_preview(aux["final_leakage_map"][index:index + 1].clamp(0, 1)))
                    visual_index += 1
        if not records:
            payload = {"version": "v2.36", "automatic_decision": "V236_NO_VALID_SAMPLES"}
        else:
            keys = sorted({key for row in records for key in row if key != "sample_id"})
            summary = {
                f"median_{key}": float(np.median([row[key] for row in records]))
                for key in keys
            }
            summary["count"] = len(records)
            failed = []
            if max(row["face_rgb_change_max"] for row in records) > 1e-6:
                failed.append("V236_FACE_PRESERVATION_FAIL")
            if max(row["non_hair_change_max"] for row in records) > 1e-6:
                failed.append("V236_LEAKAGE_FAIL")
            if float(summary.get("median_hair_reference_progress", 0.0)) < 0.50:
                failed.append("V236_HAIR_CHROMA_FAIL")
            payload = {
                "version": "v2.36", "training": False,
                "mode": "HAIR_APPEARANCE_DECOMPOSITION_TRANSFER",
                ...
                "illumination_gain": USER_V236_ILLUMINATION_GAIN,
                "summary": summary, "failed_gates": failed,
                "automatic_decision": failed[0] if failed else "V236_READY_FOR_VISUAL_REVIEW",
            }
            (root / "per_sample.jsonl").write_text(
                "\n".join(json.dumps(row, ensure_ascii=False) for row in records) + "\n",
                encoding="utf-8",
            ...
            for filename, tokens in {
                "hair_chroma.json": ("hair_chroma", "hair_reference", "chroma_confidence"),
                "hair_illumination.json": ("illumination",),
                "identity_protection.json": ("face_", "non_hair", "leakage"),
                "texture_boundary.json": ("texture", "boundary"),
            }.items():
        ...
        (root / "v236_acceptance.json").write_text(
        ...
        (root / "fixed_regression_manifest.json").write_text(
            json.dumps({"sample_ids": visual_ids, "visual_column_order": [
                "Source", "Shape Reference", "Color Reference", "Base/SATD",
                "Strong Anchor", "V2.33 Final", "V2.36 Chroma", "V2.36 Illumination", "V2.36 Final",
            ]}, indent=2), encoding="utf-8",
        )
        shutil.copytree(root, active_root, dirs_exist_ok=True)
        print(f"[V2.36] failed_gates={payload.get('failed_gates', [])}")
        print(f"[V2.36] Decision={payload['automatic_decision']}")
        return payload
...
"""
    ...
    def train_loop(self):
        ...
        if USER_V243_DIAGNOSTIC_ONLY:
            ...
            summary = self.run_v2412_diagnostic()
            history = [{"phase": "v242_target_hair_core_ownership_new_growth_diagnostic_only", **summary}]
        elif USER_V2412_DIAGNOSTIC_ONLY:
            summary = self.run_v2412_diagnostic()
            history = [{"phase": "v2412_final_correctness_eval_alignment_fix_diagnostic_only", **summary}]
        elif USER_V2411_DIAGNOSTIC_ONLY:
            summary = self.run_v2411_diagnostic()
            history = [{"phase": "v2411_implementation_correctness_fix_diagnostic_only", **summary}]
        elif USER_V241_DIAGNOSTIC_ONLY:
            summary = self.run_v241_diagnostic()
            history = [{"phase": "v241_stable_hue_gamut_face_guard_diagnostic_only", **summary}]
        elif USER_V240_DIAGNOSTIC_ONLY:
            ...
            summary = self.run_v238_diagnostic()
            history = [{"phase": "v238_target_hair_occlusion_aware_matte_diagnostic_only", **summary}]
        elif USER_V237_DIAGNOSTIC_ONLY:
...
def main():
    ...
    if USER_V243_DIAGNOSTIC_ONLY:
        print(
            "[V2.43] training=False\n"
            "[V2.43] confidence_core=DISTANCE_ANCHOR_STRAND_SKIN_CONFLICT\n"
            "[V2.43] matte=STRAND_AWARE_WITH_FLYAWAY_SUPPORT\n"
            "[V2.43] appearance=PHOTOMETRIC_SCENE_LIGHT_REFERENCE_CHROMA\n"
            "[V2.43] acceptance=V243_NAMESPACE",
            file=sys.stderr,
        )
    elif USER_V2412_DIAGNOSTIC_ONLY:
        print(
            "[V2.41.2] training=False\n"
            "[V2.41.2] illumination_double_counting=False\n"
            "[V2.41.2] resolver=EVIDENCE_FIRST_UNIFIED_HAIR_EVIDENCE\n"
            "[V2.41.2] evaluation=VALID_ONLY_DISTRIBUTION_METRICS",
            file=sys.stderr,
        )
    elif USER_V2411_DIAGNOSTIC_ONLY:
        print(
            "[V2.41.1] training=False\n"
            "[V2.41.1] illumination_owner=TARGET_BASE_SATD\n"
            "[V2.41.1] evidence_owner=UNIFIED_ANCHOR_HAIR_EVIDENCE\n"
            "[V2.41.1] correctness_fix=True",
            file=sys.stderr,
        )
    elif USER_V241_DIAGNOSTIC_ONLY:
        mode_header = "[V2.41] mode=STABLE_HUE_GAMUT_FACE_GUARD\n"
        mode_details = (
            "[V2.41] training=False\n"
            "[V2.41] carrier=V2.40_STRONG_ANCHOR_MULTIBAND\n"
            "[V2.41] hue_owner=REFERENCE_STABLE_SINGLE_DIRECTION\n"
            "[V2.41] gamut_owner=CORRECT_LOCAL_LAB_BINARY_SEARCH\n"
            "[V2.41] face_guard=FULL_FACE_SKIN_OVERLAP_SOFT_GUARD"
        )
    elif USER_V240_DIAGNOSTIC_ONLY:
        print(
        ...
        print(
            ...
            "[V2.39] target_illumination_owner=TARGET_LOW_FREQUENCY_RESIDUAL\n"
            "[V2.39] topology_owner=V2.38_OCCLUSION_AWARE_MATTE\n"
            f"[V2.39] illumination_scale={USER_V239_ILLUMINATION_SCALE}",
            file=sys.stderr,
        )
    elif USER_V238_DIAGNOSTIC_ONLY:
        print(
            "[V2.38] training=False\n"
            "[V2.38] non_hair_owner=BASE_SOURCE_PRESERVED\n"
            "[V2.38] topology_owner=TARGET_HAIR_COARSE_PRIOR\n"
            "[V2.38] occlusion_owner=TARGET_HAIR_OCCLUSION_RESOLVER\n"
            "[V2.38] matte_owner=HIGH_RES_RULE_BASED_REFINER\n"
            f"[V2.38] face_guard={USER_V238_FACE_GUARD}",
            file=sys.stderr,
        )
    elif USER_V237_DIAGNOSTIC_ONLY:
        print(
        ...
        print(
            ...
            "[V2.36] illumination_owner=TARGET_SATD_HAIR_LOW_FREQUENCY_L\n"
            "[V2.36] structure_owner=STRONG_ANCHOR\n"
            "[V2.36] full_image_color_embedding=False\n"
            f"[V2.36] gains=({USER_V236_CHROMA_GAIN},{USER_V236_ILLUMINATION_GAIN})",
            file=sys.stderr,
        )
    elif USER_V235_DIAGNOSTIC_ONLY:
        print(
    ...
    mode_details = (
        ...
        "[V2.36] illumination_channels=TARGET_SATD_LOW_FREQUENCY_L_ONLY\n"
        "[V2.36] structure_owner=STRONG_ANCHOR\n"
        f"[V2.36] chroma_radius={USER_V236_CHROMA_RADIUS} residual_radius={USER_V236_CHROMA_RESIDUAL_RADIUS} illumination_radius={USER_V236_ILLUMINATION_RADIUS}\n"
        f"[V2.36] gains=({USER_V236_CHROMA_GAIN},{USER_V236_ILLUMINATION_GAIN})\n"
        f"[V2.36] base_checkpoint={USER_V227_BASE_CHECKPOINT}"
        if USER_V236_DIAGNOSTIC_ONLY else
        "[V2.35] training=False\n"
        "[V2.35] full_image_color_embedding=False\n"
        "[V2.35] full_feature_injection=False\n"
        "[V2.35] reference_input=HAIR_ONLY_RGB_CROP\n"
    ...
    if USER_V243_DIAGNOSTIC_ONLY:
        mode_header = "[V2.43] mode=CONFIDENCE_CORE_STRAND_MATTE_PHOTOMETRIC\n"
        mode_details = (
            "[V2.43] training=False\n"
            "[V2.43] confidence_core=DISTANCE_PRIOR_PLUS_ANCHOR_EVIDENCE_PLUS_STRAND\n"
            "[V2.43] illumination_owner=EXISTING_NEW_HAIR_SPLIT\n"
            "[V2.43] acceptance=V243_ONLY"
        )
    elif USER_V2412_DIAGNOSTIC_ONLY:
        mode_header = "[V2.41.2] mode=FINAL_CORRECTNESS_EVAL_ALIGNMENT_FIX\n"
        mode_details = (
            "[V2.41.2] training=False\n"
            "[V2.41.2] illumination_owner=REFERENCE_TONE_PLUS_TARGET_VARIATION_ONCE\n"
            "[V2.41.2] resolver=UNIFIED_HAIR_EVIDENCE_FIRST\n"
            "[V2.41.2] acceptance=VALID_ONLY_DISTRIBUTION_METRICS"
        )
    elif USER_V2411_DIAGNOSTIC_ONLY:
        mode_header = "[V2.41.1] mode=IMPLEMENTATION_CORRECTNESS_FIX\n"
        mode_details = (
            "[V2.41.1] training=False\n"
            "[V2.41.1] illumination_owner=TARGET_BASE_SATD\n"
            "[V2.41.1] stable_hue=REFERENCE_SINGLE_DIRECTION\n"
            "[V2.41.1] face_guard=UNIFIED_HAIR_EVIDENCE"
        )
    elif USER_V241_DIAGNOSTIC_ONLY:
        mode_header = "[V2.41] mode=STABLE_HUE_GAMUT_FACE_GUARD\n"
        mode_details = (
            "[V2.41] training=False\n"
            "[V2.41] stable_hue=REFERENCE_SINGLE_DIRECTION\n"
            "[V2.41] gamut=LOCAL_CHROMA_BINARY_SEARCH\n"
            "[V2.41] face_guard=FULL_OVERLAP_CONTAMINATION_GUARD"
        )
    elif USER_V240_DIAGNOSTIC_ONLY:
        ...
        mode_details = (
            ...
            "[V2.39] target_illumination_owner=TARGET_LOW_FREQUENCY_RESIDUAL\n"
            "[V2.39] topology_owner=V2.38_OCCLUSION_AWARE_MATTE\n"
            "[V2.39] strong_anchor_owner=HIGH_FREQUENCY_L_STRUCTURE\n"
            f"[V2.39] illumination_scale={USER_V239_ILLUMINATION_SCALE}"
        )
    elif USER_V238_DIAGNOSTIC_ONLY:
        mode_header = "[V2.38] mode=TARGET_HAIR_OCCLUSION_AWARE_MATTE\n"
        mode_details = (
            "[V2.38] training=False\n"
            "[V2.38] non_hair_owner=BASE_SOURCE_PRESERVED\n"
            "[V2.38] topology_owner=TARGET_HAIR_COARSE_PRIOR\n"
            "[V2.38] occlusion_owner=TARGET_HAIR_OCCLUSION_RESOLVER\n"
            "[V2.38] matte_owner=HIGH_RES_RULE_BASED_REFINER\n"
            f"[V2.38] contact_radius={USER_V238_CONTACT_RADIUS} matte_ring_radius={USER_V238_MATTE_RING_RADIUS}\n"
            f"[V2.38] base_checkpoint={USER_V227_BASE_CHECKPOINT}"
        )
    print(
