...
# 2. 严格导入原版模块：不带任何后缀 
try:
    from hair_swap_gem import HairFast, get_parser
...
# ======================= 用户配置区域 =======================
DATASET_DIR = "celeba-1024/celeba-1024/"                # 原始图片目录
INPUT_CSV = "fixed_both_test_3000.csv"          # 3000组固定清单
OUTPUT_DIR = "results_both_satd_stage2" # 复现结果保存目录

# 填写你复现出来的第二阶段权重路径 
# 注意：这通常是你在训练作者原版代码时产生的 .pth 文件
MY_CHECKPOINT = "output/blending_train_v8/checkpoints/best.pth"
