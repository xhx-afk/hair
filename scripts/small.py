...
def main():
    ...
    pairs = sample_pairs(face_images, shape_images, ACTIVE_DATASET_SIZE, USER_ALLOW_REUSE_ACROSS_PAIRS, USER_RANDOM_SEED)
    ...
    print(f"Saved {len(pairs)} SATD pairs to {ACTIVE_OUTPUT_DIR / 'dataset.exps'}")
