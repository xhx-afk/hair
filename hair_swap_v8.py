...
class HairFast_v8:
    ...
    def swap(
        ...
        **kwargs,
        ...
        if (
            getattr(self.args, "v243_enabled", False)
            or
            getattr(self.args, "v241_enabled", False)
            or
            getattr(self.args, "v238_enabled", False)
            or
            getattr(self.args, "v239_enabled", False)
            or
            getattr(self.args, "v240_enabled", False)
            or
...
def get_parser_v8():
    ...
    parser.add_argument("--disable-v236", dest="v236_enabled", action="store_false")
    parser.set_defaults(v236_enabled=True)
    parser.add_argument("--v236-chroma-radius", type=int, default=9)
    parser.add_argument("--v236-chroma-residual-radius", type=int, default=3)
    parser.add_argument("--v236-illumination-radius", type=int, default=11)
    parser.add_argument("--v236-chroma-scale", type=float, default=18.0)
    ...
    parser.add_argument("--disable-v239", dest="v239_enabled", action="store_false")
    parser.set_defaults(v239_enabled=True)
    parser.add_argument("--v239-palette-mad-scale", type=float, default=3.5)
    parser.add_argument("--v239-palette-min-support", type=int, default=16)
    parser.add_argument("--v239-illumination-radius", type=int, default=11)
    parser.add_argument("--v239-illumination-scale", type=float, default=0.9)
    parser.add_argument("--v239-anchor-hf-gain", type=float, default=0.9)
    parser.add_argument("--v239-contact-radius", type=int, default=5)
    parser.add_argument("--v239-risk-strength", type=float, default=0.65)
    parser.add_argument("--v239-matte-ring-radius", type=int, default=5)
    parser.add_argument("--v239-face-guard", type=float, default=0.35)
    parser.add_argument("--disable-v240", dest="v240_enabled", action="store_false")
    parser.set_defaults(v240_enabled=True)
    parser.add_argument("--v240-palette-mad-scale", type=float, default=3.5)
    parser.add_argument("--v240-palette-min-support", type=int, default=16)
    parser.add_argument("--v240-illumination-radius", type=int, default=11)
    parser.add_argument("--v240-carrier-mid-radius", type=int, default=3)
    parser.add_argument("--v240-mid-gain", type=float, default=1.0)
    parser.add_argument("--v240-high-gain", type=float, default=0.95)
    parser.add_argument("--v240-chroma-mid-gain", type=float, default=0.35)
    parser.add_argument("--v240-chroma-high-gain", type=float, default=0.20)
    parser.add_argument("--v240-contact-radius", type=int, default=5)
    parser.add_argument("--v240-risk-strength", type=float, default=0.65)
    parser.add_argument("--v240-matte-ring-radius", type=int, default=5)
    parser.add_argument("--v240-face-guard", type=float, default=0.35)
    parser.add_argument("--disable-v241", dest="v241_enabled", action="store_false")
    ...
    parser.add_argument("--v241-carrier-mid-radius", type=int, default=3)
    parser.add_argument("--v241-mid-gain", type=float, default=1.0)
    parser.add_argument("--v241-high-gain", type=float, default=0.95)
    parser.add_argument("--v241-chroma-mid-gain", type=float, default=0.35)
    parser.add_argument("--v241-chroma-high-gain", type=float, default=0.20)
    parser.add_argument("--v241-contact-radius", type=int, default=5)
    parser.add_argument("--v241-risk-strength", type=float, default=0.65)
    parser.add_argument("--v241-matte-ring-radius", type=int, default=5)
